...
# 训练和验证函数
def train_and_validate(model, train_loader, val_loader, criterion, optimizer, scheduler, num_epochs=100):
...
if __name__ == "__main__":
    ...
    model = DeepTabularNet(
        ...
        hidden_dims=[512, 256, 128, 64]  # 可以根据数据复杂度调整
    ).to(device)
